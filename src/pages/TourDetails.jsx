...
import calculateAvgRating from "../ultil/avgRating";
                ...
                <div className="tour__content">
                  ...
                  <div className="tour__info">
                    ...
                    <div className="tour__extra-details">
                      ...
                      <span>
                        <i class="ri-map-pin-time-line"></i> $ {price} k/m
                      </span>
                      <span>
                  ...
                  {/* =========== reviews=====*/}
                  <div className="tour__reviews mt-4 border p-4">
                          ...
                          <div className="w-100">
                            <div className="d-flex align-items-center justify-content-between">
                              ...
                              <span className="d-flex align-items-center">
                                {review?.rating} <i class="ri-star-line"></i>
                              </span>
                            </div>
